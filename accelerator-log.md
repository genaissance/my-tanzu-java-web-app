...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=genaissance&repo=my-tanzu-java-web-app",
  "includeBuildToolWrapper" : true,
  "javaVersion" : "11",
  "projectName" : "my-tanzu-java-web-app",
  "repositoryPrefix" : "mamburger.azurecr.io/tap-apps/",
  "updateBoot3" : false
}
```
## Log
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->my-tanzu-java-web-ap...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->mamburger.azurecr.io...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: my-tanzu-java-web-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=genaissance&repo=my-tanzu-java-web-app'
